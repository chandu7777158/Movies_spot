            ...
            <div className="container-fluid d-flex align-items-center">
                ...
                <div className="collapse navbar-collapse" id="navbarNav">
                    <ul className="navbar-nav ms-2 mb-2 mb-lg-0 text-center">
                        {navItems.map((item) => (
                            //It is a string eventually,it's stored inside an object (item), we have to "evaluate" the object to get the string out.
                            <li className="nav-item" key={item.label}>
                                <Link className="nav-link nav-highlight px-lg-3 fw-bold" >
                                    {item.label}
                                </Link>
                            </li>
                        ))}
