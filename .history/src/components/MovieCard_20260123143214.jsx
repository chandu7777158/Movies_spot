...
export default function MovieCard() {
    return (
        <div className="col-12 col-sm-6 col-md-4 col-lg-22.5 mb-4"> {/* Responsive Grid Columns */}
            <div className="card h-100 border-0 shadow-sm movie-card">
                <img 
                    src="https://www.shutterstock.com/image-vector/online-cinema-art-movie-watching-260nw-584655766.jpg" 
