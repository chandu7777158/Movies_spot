...
const MoviePage = ({ category }) => {
    ...
    //[category,query] An effect must re-run when the anyone dependency changes then it re-render. if we keep empty array it only runs one time 
    useEffect(() => {
    ...
    return (
        //JSX is evaluated during render, useEffect is scheduled during render, useEffect executes after render
        //Movies depend on category,Movies depend on search query, If either changes → fetch new data
